...
import { updateMachinary } from "@/lib/actions/machinary.actions";
...
interface EditMachinaryCardProps {
  id: string;
  type: string;
  maintenance: Date;
  status: string;
...
const EditMachinaryCard = ({
  id,
  type,
  maintenance,
  predictive,
}: EditMachinaryCardProps) => {
...
export default EditMachinaryCard;
